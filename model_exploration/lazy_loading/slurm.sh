...
srun --mem=0 torchrun \
    ...
    --rdzv_backend=c10d \
    st_trainer_ddp_hf_stream.py --resume_checkpoint_path /rhome/sawale/indus_traning/sentense_transformers/model_exploration/tmp_models/nrows_None__nsrc_None/timestamp_20250505_16-10-36/indus-sde-v0.2/checkpoints/checkpoint-126000 --resume_run_id 9olox5mz --batch_size 32 --gradient_accumulation_steps 16 --lr 3.0e-5
echo "<<<<<< test python file"

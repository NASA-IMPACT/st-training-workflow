...
# load_dotenv("../model_exploration/.env")
# hf_token = os.getenv("HUGGINGFACE_TOKEN")

# Define the device to use
ks = [1, 3, 5, 10]
json_output_path = "results_json/nasa_sde_ir_eval_dump_v2.json"
output_dir_plots = "results_plots/nasa_sde_ir_eval_plots_v2"
...
embeddings = {
    "[OpenAI]text-embedding-3-small": "/rhome/sawale/indus_traning/sentense_transformers/eval/openai_emb_cache/text-embedding-3-small/nasa-sde-IR-benchmark-sample-v2",
    "[OpenAI]text-embedding-3-large": "/rhome/sawale/indus_traning/sentense_transformers/eval/openai_emb_cache/text-embedding-3-large/nasa-sde-IR-benchmark-sample-v2",
}
...
if __name__ == "__main__":
    ...
    g.fig.suptitle(
        "Model Performance Comparison by Metric and K-Value On NASA SDE IR V2",
        y=1.03,
    )
    ...
    # Display the plot
    plt.savefig(
        os.path.join(output_dir_plots, f"NASA_SDE_IR_performance_plots_v2.png"),
        bbox_inches="tight",
    )
    # plt.show()
